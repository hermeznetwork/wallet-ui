...
// ToDo: Header
// If this is some data to render the header of the pages it should not belong to domain
// We'll have it here while its usage is clarified and all its possible shapes determined
// At some point it should be moved to the presentation namespace

  ...
  return (
    <Sidenav onClose={onClose}>
      <div className={classes.root}>
        ...
        <img className={classes.tokenImage} src={heztoken} alt="Hermez token" />
        {(() => {
          if (
          ...
          if (
            ...
            return (
              <p className={classes.apiNotAvailableError}>
                There was a problem loading the information on this page. Please, try to access it
                again later.
              </p>
            );
          }
          ...
          return isRewardActive === false ? (
            <>
              <p className={classes.finishedText}>
                Thank you for participating in the Hermez reward program. You will receive your HEZ
                in next few days.
              </p>
              <div className={classes.rewardCard}>
                <div className={classes.rewardGroup}>
                  <p className={classes.rewardTitle}>Your total reward</p>
              ...
              <div className={classes.infoTextWrapper}>
                ...
                <p className={classes.infoText}>
                  The value of the reward is estimated, it may vary slightly from the reward finally
                  received.
                </p>
              </div>
            </>
            ...
            <>
              <p className={classes.timeLeft}>{date.getTimeLeft(rewardRemainingTime)}</p>
              {accountEligibilityTask.data ? (
                <div className={classes.eligibleTextWrapper}>
                  <GreenCircleWhiteThickIcon className={classes.eligibleIcon} />
                  <p className={classes.eligibleText}>You are eligible to earn rewards.</p>
                </div>
              ) : (
                <>
                  <p className={classes.eligibilityCriteriaTitle}>
              ...
              <div className={classes.rewardCard}>
                <div className={classes.rewardGroup}>
                  ...
                  <p className={`${classes.reward} ${classes.rewardPercentage}`}>
                    {rewardPercentageTask.data
                      ? getFormattedPercentage(rewardPercentageTask.data)
                      : "--"}
                    %
                  </p>
                </div>
                <div className={classes.rewardGroup}>
                  <p className={classes.rewardTitle}>You earned so far</p>
                  {accountEligibilityTask.data ? (
                    <p className={classes.reward}>
                      {getFormattedEarnedReward(earnedRewardTask.data)} HEZ (
              ...
              <div className={classes.infoTextWrapper}>
                <InfoGreyIcon className={classes.infoIcon} />
                <p className={classes.infoText}>
                  Values are estimated and updated once per day. You will receive your reward at the
                  end of the program.
                </p>
              </div>
              <a

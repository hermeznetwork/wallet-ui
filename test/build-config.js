...
const synchConfigPath = path.join(__dirname, "../../rollup/rollup-operator/test/config/synch-config-pob-test.json");
const testPath = path.join(__dirname, "../../rollup/rollup-operator/test/config/test-pob.json");
